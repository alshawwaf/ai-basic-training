...
- **Project** — A working security analyst assistant that answers questions about CVEs and threat reports

---

## Lessons

### Lesson 4.1 — [How LLMs Work](01_how_llms_work/README.md)
...
### Lesson 4.3 — [The Claude API](03_llm_api/README.md)
Build a conversational threat intelligence assistant using Anthropic's Claude.

### Lesson 4.4 — [Retrieval-Augmented Generation](04_rag/README.md)
Ground the model's answers in your own security documents to reduce hallucination.

### Project — [Security Analyst Assistant](project/security_assistant.py)
