...
print("\n--- Exercise 3 complete. Open solution_semantic_search.py to compare. ---")
print("--- Next: stage4_genai/03_llm_api/README.md ---")
```
...
At this point your file contains all the working code. Compare it against the matching solution file (`solution_semantic_search.py`) if anything looks different.
