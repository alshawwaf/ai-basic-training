# =============================================================================
# LESSON 1.5 | WORKSHOP | Exercise 2 of 5
# Confusion Matrix
# =============================================================================
# WHAT YOU WILL LEARN
# -------------------
# - What TP, TN, FP, FN mean in a security context
# - How to compute the confusion matrix manually using boolean masking
# - How to verify with sklearn and visualise as a heatmap
# - How to derive accuracy, precision, recall, F1 from the matrix
#
# RUN THIS FILE
# -------------
#   python module1_classic_ml/lesson5_model_evaluation/workshop/exercise2_confusion_matrix.py
# =============================================================================
...
# BACKGROUND
# =============================================================================
# The confusion matrix shows all four types of prediction outcome:
#
...
#
# In security:
#   FP = false alarm (analyst reviews a benign event)   — annoying but manageable
#   FN = missed attack (threat actor gets through)       — potentially catastrophic
# Good security models minimise FN even at the cost of more FP.

# =============================================================================
# TASK 1 — Compute TN, FP, FN, TP Manually
# =============================================================================
# Using boolean operations on y_test and y_pred arrays, compute each cell.
# Print each value with its security meaning.
...
# =============================================================================
# Use sklearn's confusion_matrix() to get the 2x2 array.
# Print it as a labelled table. Verify it matches Task 1's values.
...
# =============================================================================
# TASK 3 — Derive All Metrics from TP/TN/FP/FN
# =============================================================================
# Using only TP, TN, FP, FN (the variables from Task 1), compute:
#   accuracy, precision, recall, specificity, F1
# Print each with its formula as a comment.
...
# Annotate each cell with its count AND percentage of total.
# Label axes: "Predicted" (x) and "Actual" (y).
