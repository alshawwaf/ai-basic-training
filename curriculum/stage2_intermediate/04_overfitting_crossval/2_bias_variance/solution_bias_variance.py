...
# Inject Gaussian noise so the bias/variance regimes are actually visible.
...
plt.tight_layout()
plt.savefig('stage2_intermediate/lesson4_ex2_boundaries.png')
plt.close()
...
plt.tight_layout()
plt.savefig('stage2_intermediate/lesson4_ex2_learning_curves.png')
plt.close()
print("Learning curves plot saved.")

print("\n--- Exercise 2 complete. Move to ../3_kfold_crossval/solution.py ---")
