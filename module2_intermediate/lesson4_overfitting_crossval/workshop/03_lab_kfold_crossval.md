...
Create a new file called `exercise3_kfold_crossval.py` in this folder.
...
At this point your file contains all the working code. Compare it against the matching `_solution_` file (`03_solution_kfold_crossval.py`) if anything looks different.
