...
At this point your file contains all the working code. Compare it against the matching solution file `solution_roc_and_auc.py` if anything looks different.
