...
At this point your file contains all the working code. Compare it against the matching solution file (`solution_conv_and_pooling.py`) if anything looks different.
