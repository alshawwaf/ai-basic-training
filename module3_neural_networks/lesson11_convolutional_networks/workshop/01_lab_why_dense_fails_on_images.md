...
At this point your file contains all the working code. Compare it against the matching `_solution_` file (`01_solution_why_dense_fails_on_images.py`) if anything looks different.
