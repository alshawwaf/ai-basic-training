...
Create a new file called `exercise4_evaluate_regression.py` in this folder.
...
Compute residuals for the test set: residuals = y_test - y_pred_test Print: - mean residual (should be near 0)
