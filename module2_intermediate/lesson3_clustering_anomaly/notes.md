...
**[Lesson 2.4 — Cross-Validation & Overfitting](../lesson4_overfitting_crossval/notes.md):** How to know if your model will actually work on new data — not just the data you trained on.
