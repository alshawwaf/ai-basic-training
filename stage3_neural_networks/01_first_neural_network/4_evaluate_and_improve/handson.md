...
print("\n--- Workshop complete. Open solution_evaluate_and_improve.py to compare. ---")
```
...
At this point your file contains all the working code. Compare it against `solution_evaluate_and_improve.py` if anything looks different.
