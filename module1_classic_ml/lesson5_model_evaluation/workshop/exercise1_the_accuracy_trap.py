# =============================================================================
# LESSON 1.5 | WORKSHOP | Exercise 1 of 5
# The Accuracy Trap
# =============================================================================
# WHAT YOU WILL LEARN
# -------------------
# - Why accuracy is misleading on imbalanced security datasets
# - How DummyClassifier achieves 95% accuracy while catching 0 attacks
# - How to immediately identify the accuracy trap from a classification report
# - Why security metrics require more than just accuracy
#
# RUN THIS FILE
# -------------
...
# BACKGROUND
# =============================================================================
# Real security datasets are almost always imbalanced: attacks are rare.
# In a dataset with 95% benign and 5% attacks, a model that predicts
# "benign" for every single event achieves 95% accuracy — without ever
# detecting a single attack.
#
# DummyClassifier(strategy='most_frequent') does exactly this. Its accuracy
# equals the proportion of the most common class. Any real model must beat
# this baseline on metrics that matter: recall and precision for the attack class.
...
# Features: connection_rate, bytes_sent, unique_ports (3 features for simplicity)
...
# =============================================================================
# TASK 1 — Inspect the Class Imbalance
# =============================================================================
# Count the number of benign and attack samples in the full dataset.
# Print each with the percentage. Confirm: attack rate is 5%.
...
# =============================================================================
# TASK 2 — Train DummyClassifier and Show the Trap
# =============================================================================
# Fit DummyClassifier(strategy='most_frequent') on X_train / y_train.
# Print its accuracy on X_test / y_test.
# Print the full classification_report.
# Write a comment explaining why accuracy=0.95 is misleading.
...
# =============================================================================
# TASK 3 — Compare with LogisticRegression
# =============================================================================
# Scale features, train LogisticRegression.
# Build a comparison table showing accuracy AND attack recall for both models.
...
# =============================================================================
# TASK 4 (BONUS) — Daily Cost of the Accuracy Trap
# =============================================================================
# Assume 10,000 network events per day, 5% attack rate = 500 attacks/day.
# For each model, compute: how many attacks are missed per day?
...
print("\n--- Exercise 1 complete. Move to exercise2_confusion_matrix.py ---")
