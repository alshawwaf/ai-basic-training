...
plt.tight_layout()
plt.savefig('module2_intermediate/lesson3_ex3_elbow.png')
plt.close()
...
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('module2_intermediate/lesson3_ex3_silhouette.png')
plt.close()
...
ax.legend()
plt.tight_layout()
plt.savefig('module2_intermediate/lesson3_ex3_silhouette_diagram.png')
plt.close()
print("Silhouette diagram created (sample of 500 points).")

print("\n--- Exercise 3 complete. Move to 04_solution_anomaly_scoring.py ---")
