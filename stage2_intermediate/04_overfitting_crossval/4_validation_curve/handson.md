...
print("=" * 60)
print("\n--- Workshop complete. Open solution_validation_curve.py to compare. ---")
...
At this point your file contains all the working code. Compare it against the matching solution file (`solution_validation_curve.py`) if anything looks different.
