...
|---|-------|---------------|-------|
| 1 | [exercise1_chunking.md](exercise1_chunking.md) | [exercise1_chunking.py](exercise1_chunking.py) | Document chunking strategies — fixed-size, overlap, by sentence |
| 2 | [exercise2_retrieval.md](exercise2_retrieval.md) | [exercise2_retrieval.py](exercise2_retrieval.py) | Encode chunks and retrieve top-k by cosine similarity |
| 3 | [exercise3_rag_pipeline.md](exercise3_rag_pipeline.md) | [exercise3_rag_pipeline.py](exercise3_rag_pipeline.py) | Full RAG: retrieve relevant chunks + augment prompt + generate |
