...
At this point your file contains all the working code. Compare it against the matching solution file (`solution_why_raw_logs_fail.py`) if anything looks different.
