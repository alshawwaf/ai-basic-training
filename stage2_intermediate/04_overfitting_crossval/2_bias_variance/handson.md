...
Create a new file called `02_bias_variance.py` in this folder.
...
print("=" * 60)
print("\n--- Exercise 2 complete. Move to 03_kfold_crossval.py ---")
...
At this point your file contains all the working code. Compare it against the matching solution file (`solution_bias_variance.py`) if anything looks different.
