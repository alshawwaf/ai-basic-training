...
plt.legend()
plt.tight_layout()
plt.savefig('module2_intermediate/lesson3_ex2_clusters.png')
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig('module2_intermediate/lesson3_ex2_true_labels.png')
plt.close()
...
print("\n--- Exercise 2 complete. Move to 03_solution_choosing_k.py ---")
