# =============================================================================
# LESSON 2.4 | WORKSHOP | Exercise 3 of 4
# K-Fold Cross-Validation
# =============================================================================
# WHAT YOU WILL LEARN
# -------------------
# - Why a single train/test split gives unreliable performance estimates
# - How cross_val_score() implements K-fold CV efficiently
# - How 5-fold vs 10-fold CV differ in variance of the estimate
# - How to use CV to select hyperparameters (tree depth)
#
# RUN THIS FILE
# -------------
#   python module2_intermediate/lesson4_overfitting_crossval/workshop/exercise3_kfold_crossval.py
# =============================================================================
...
# =============================================================================
# 1. Train depth=5 tree on X_train_all, evaluate on X_test → single score
# 2. Run cross_val_score with cv=5 on X_train_all
# Print both. Show the std from CV tells you how reliable the single split is.
...
# =============================================================================
# TASK 4 (BONUS) — Verify Class Balance in Folds
# =============================================================================
# Use StratifiedKFold to manually iterate over folds.
# For each fold, print the fraction of attack samples.
# Show all folds have approximately the same class ratio.
...
print("\n--- Exercise 3 complete. Move to exercise4_validation_curve.py ---")
