# =============================================================================
# LESSON 1.4 | WORKSHOP | Exercise 2 of 4
# Train and Read the Tree
# =============================================================================
# WHAT YOU WILL LEARN
# -------------------
# - How to train a DecisionTreeClassifier
# - How to export the tree as readable text rules
# - How to visualise the tree with plot_tree()
# - How to interpret what the model actually learned
#
# RUN THIS FILE
# -------------
#   python module1_classic_ml/lesson4_decision_trees/workshop/exercise2_train_and_read_the_tree.py
# =============================================================================
...
# BACKGROUND
# =============================================================================
# DecisionTreeClassifier builds the if/else tree we described in Exercise 1.
# Setting max_depth limits how deep the tree can grow — this prevents overfitting
# (a tree with no depth limit can memorise every training example perfectly).
# After fitting, we can inspect the rules the model learned using export_text()
# or visualise them with plot_tree(). These rules are directly interpretable
# as firewall or IDS policies.

# =============================================================================
# TASK 1 — Train the Classifier
# =============================================================================
# Create a DecisionTreeClassifier with max_depth=4 and random_state=42.
...
# =============================================================================
# TASK 2 — Export the Tree as Text Rules
# =============================================================================
# Use export_text(model, feature_names=FEATURES) to get the rule string.
# Print the first 40 lines.
# Then identify and print the root node's split feature and threshold.
# Write a comment explaining what that split means for network security.
...
# =============================================================================
# Use plot_tree() to create a figure.
# Set: feature_names=FEATURES, class_names=CLASS_NAMES, filled=True, fontsize=10
# Figure size: (20, 10).
# After viewing it, write a comment describing:
#   a) What the root node splits on and why that makes security sense
#   b) What happens in the left subtree (low connection_rate)
...
# =============================================================================
# TASK 4 (BONUS) — Trace a Sample Through the Tree
# =============================================================================
# Pick the first test sample (X_test.iloc[0]).
# Print its feature values.
# Predict its class and the probabilities for all 4 classes.
# Write a comment explaining which path through the tree it most likely took.
