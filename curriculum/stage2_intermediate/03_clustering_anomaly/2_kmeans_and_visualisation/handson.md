...
At this point your file contains all the working code. Compare it against the matching solution file (`solution_kmeans_and_visualisation.py`) if anything looks different.
