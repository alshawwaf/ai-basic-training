...
If you haven't already, activate your virtual environment and install the libraries used throughout Stage 4:
...
At this point your file contains all the working code. Compare it against the matching solution file (`solution_zero_shot_classification.py`) if anything looks different.
