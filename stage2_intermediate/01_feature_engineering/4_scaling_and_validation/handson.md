...
print("--- Next: stage2_intermediate/02_random_forests/ ---")
```
...
At this point your file contains all the working code. Compare it against the matching solution file (`solution_scaling_and_validation.py`) if anything looks different.
