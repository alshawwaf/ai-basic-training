...
print("--- Open 03_solution_rag_pipeline.py to compare your implementation. ---")
```
...
At this point your file contains all the working code. Compare it against the matching `_solution_` file (`03_solution_rag_pipeline.py`) if anything looks different.
