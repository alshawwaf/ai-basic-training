# =============================================================================
# LESSON 2.3 | WORKSHOP | Exercise 2 of 4
# K-Means and Visualisation
# =============================================================================
# WHAT YOU WILL LEARN
# -------------------
# - How to fit KMeans and inspect cluster assignments
# - How to use PCA to visualise 6D clusters in 2D
# - How to compare cluster assignments to true labels
# - How to measure cluster purity
#
# RUN THIS FILE
# -------------
#   python module2_intermediate/lesson3_clustering_anomaly/workshop/exercise2_kmeans_and_visualisation.py
# =============================================================================
...
# BACKGROUND
# =============================================================================
# K-Means groups samples by minimising within-cluster distances.
# It needs scaled features — bytes_sent (0-250000) would otherwise dominate.
# PCA compresses 6 features to 2 for plotting, keeping the directions of
# maximum variance. Cluster purity tells us how well clusters align with
# the true traffic types.

# =============================================================================
# TASK 1 — Scale and Fit K-Means (k=4)
# =============================================================================
# Scale X with StandardScaler. Fit KMeans(n_clusters=4, random_state=42, n_init=10).
# Print cluster sizes. Compare to expected ~750 per cluster.
...
# =============================================================================
# Fit PCA(n_components=2) on X_scaled. Transform to X_2d.
# Plot scatter coloured by cluster_labels. Mark centroids with 'X'.
...
# =============================================================================
# Plot the same PCA 2D scatter, but colour by true_classes.
# Compare to Task 2. How well do K-Means clusters align with true classes?
...
# =============================================================================
# For each cluster (0-3), print how many samples of each true_class it contains.
# Compute purity = majority_class_count / cluster_size.
...
print("\n--- Exercise 2 complete. Move to exercise3_choosing_k.py ---")
