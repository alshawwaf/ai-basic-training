...
At this point your file contains all the working code. Compare it against the matching solution file (`solution_early_stopping.py`) if anything looks different.
