# =============================================================================
# LESSON 2.3 | WORKSHOP | Exercise 3 of 4
# Choosing K
# =============================================================================
# WHAT YOU WILL LEARN
# -------------------
# - How to use the elbow method (inertia) to guide K selection
# - How silhouette score measures cluster quality
# - How to combine both methods to choose K
# - Why the right K depends on domain knowledge, not just metrics
#
# RUN THIS FILE
# -------------
#   python module2_intermediate/lesson3_clustering_anomaly/workshop/exercise3_choosing_k.py
# =============================================================================
...
# =============================================================================
# TASK 1 — Elbow Method (Inertia for K=2 to K=10)
# =============================================================================
# For each K in range(2, 11), fit KMeans and record inertia_.
# Print a table and plot the elbow curve.
...
# =============================================================================
# TASK 2 — Silhouette Score for K=2 to K=10
# =============================================================================
# For each K, fit KMeans and compute silhouette_score(X_scaled, labels).
# Print table. Plot. Identify K with highest score.
...
# =============================================================================
# TASK 4 (BONUS) — Silhouette Diagram
# =============================================================================
# Create a silhouette diagram for K=4 showing per-cluster silhouette values.
# (Each cluster is a horizontal band; wider = more samples; further right = higher score.)
...
# >>> YOUR CODE HERE
# Hint: use a sample of 500 points for performance
