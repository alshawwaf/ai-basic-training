...
| 3.9 | [First Neural Network](01_first_neural_network/README.md) | Building with Keras |
| 3.10 | [Dropout & Regularisation](02_dropout_regularisation/README.md) | Dropout + regularisation |
| 3.11 | [Convolutional Networks](03_convolutional_networks/README.md) | Convolutional networks |
| 3.12 | [Hyperparameter Tuning](04_hyperparameter_tuning/README.md) | Tuning your network |
| Project | [packet_classifier.py](project/packet_classifier.py) | Neural network packet classifier |
