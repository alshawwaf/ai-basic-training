...
You now have enough context to understand every line of the script.

**Open [1_concepts_and_data.py](1_concepts_and_data.py) and run it.**

The script walks you through loading the dataset, exploring it, and visualising it step by step. Read each comment block before the code runs — then observe the output and make sure it matches what you expected from the notes.

---

## Next Lesson

**[Lesson 1.2 — Linear Regression](2_linear_regression.md):** Your first ML model — predict server response time from traffic load.
