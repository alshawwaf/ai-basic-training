...
At this point your file contains all the working code. Compare it against the matching solution file (`solution_numeric_feature_extraction.py`) if anything looks different.
