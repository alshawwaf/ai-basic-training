...
### Lesson 1.1 — [What is ML?](01_what_is_ml/README.md)
Load, inspect, and visualise a dataset before training anything.

### Lesson 1.2 — [Linear Regression](02_linear_regression/README.md)
...
### Project — [Phishing URL Classifier](project/phishing_detector.py)
