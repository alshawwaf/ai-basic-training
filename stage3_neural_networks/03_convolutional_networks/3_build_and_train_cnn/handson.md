...
At this point your file contains all the working code. Compare it against the matching solution file (`solution_build_and_train_cnn.py`) if anything looks different.
