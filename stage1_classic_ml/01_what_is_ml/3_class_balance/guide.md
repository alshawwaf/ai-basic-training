...
[../4_visualise/guide.md](../4_visualise/guide.md) — plotting sample images, average class prototypes, and predicting where your model will struggle before it is even trained.
