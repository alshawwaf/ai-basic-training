...
At this point your file contains all the working code. Compare it against the matching solution file (`solution_why_dense_fails_on_images.py`) if anything looks different.
