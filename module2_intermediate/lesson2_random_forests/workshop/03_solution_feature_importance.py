...
ax.invert_yaxis()
plt.tight_layout()
plt.savefig('module2_intermediate/lesson2_feature_importance.png')
plt.close()
print("Plot saved to module2_intermediate/lesson2_feature_importance.png")
...
print("\n--- Exercise 3 complete. Move to 04_solution_tune_the_forest.py ---")
