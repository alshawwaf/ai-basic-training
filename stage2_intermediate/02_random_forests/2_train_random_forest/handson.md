...
At this point your file contains all the working code. Compare it against the matching solution file (`solution_train_random_forest.py`) if anything looks different.
