...
print("\n--- Exercise 3 complete. Open solution_attention.py to compare. ---")
print("--- Next: stage4_genai/02_huggingface/README.md ---")
```
...
--- Exercise 3 complete. Open solution_attention.py to compare. ---
--- Next: stage4_genai/02_huggingface/README.md ---
```
...
At this point your file contains all the working code. Compare it against the matching solution file (`solution_attention.py`) if anything looks different.
