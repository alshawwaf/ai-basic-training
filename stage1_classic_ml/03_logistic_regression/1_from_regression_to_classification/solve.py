...
plt.plot(z, sigmoid_z, linewidth=2)
plt.axhline(0.5, color="red", linestyle="--", alpha=0.5, label="threshold = 0.5")
plt.axvline(0, color="red", linestyle="--", alpha=0.5)
plt.xlabel("z (linear score)")
plt.ylabel("σ(z) = P(phishing)")
plt.title("Sigmoid Function (S-curve)")
plt.grid(alpha=0.3)
plt.legend()
plt.savefig("sigmoid_curve.png", dpi=100, bbox_inches="tight")
plt.show()
print("Sigmoid plot saved to sigmoid_curve.png")
