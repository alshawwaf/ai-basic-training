...
[../5_what_model_sees/guide.md](../5_what_model_sees/guide.md) — print raw number grids, understand which features matter, and connect digits to real security data.
