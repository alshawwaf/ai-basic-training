...
At this point your file contains all the working code. Compare it against the matching `_solution_` file (`04_solution_scaling_and_validation.py`) if anything looks different.
