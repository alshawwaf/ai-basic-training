...
**[Lesson 3.2 — Deeper Networks](../lesson10_dropout_regularisation/notes.md):** Add more layers, dropout, and batch normalisation to build a more powerful and stable model.
