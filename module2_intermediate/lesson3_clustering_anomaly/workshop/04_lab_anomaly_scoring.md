...
Create a new file called `exercise4_anomaly_scoring.py` in this folder.
...
At this point your file contains all the working code. Compare it against the matching `_solution_` file (`04_solution_anomaly_scoring.py`) if anything looks different.
