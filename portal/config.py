    ...
    },
    {
        ...
        "lessons": [
            {"id": "s2_01", "num": 1, "title": "Feature Engineering",
             ...
             "icon": "lesson-features"},
            {"id": "s2_02", "num": 2, "title": "Random Forests",
             "desc": "Ensemble methods and bagging",
             "folder": "s2_02_random_forests", "has_app": True, "minutes": 90,
             "icon": "lesson-forest"},
            {"id": "s2_03", "num": 3, "title": "k-Means Clustering",
             "desc": "Unsupervised learning for security",
             "folder": "s2_03_clustering_anomaly", "has_app": True, "minutes": 90,
             "icon": "lesson-cluster"},
            {"id": "s2_04", "num": 4, "title": "Cross-Validation & Overfitting",
             "desc": "Generalization and model selection",
             "folder": "s2_04_overfitting_crossval", "has_app": True, "minutes": 90,
             "icon": "lesson-overfit"},
        ],
    },
    {
        ...
        "lessons": [
            {"id": "s3_01", "num": 1, "title": "First Neural Network in Keras",
             "desc": "Build a neural network from scratch",
             "folder": "s3_01_first_neural_network", "has_app": True, "minutes": 120,
             "icon": "lesson-perceptron"},
            {"id": "s3_02", "num": 2, "title": "Deeper Networks & Dropout",
             "desc": "Prevent overfitting in deep networks",
             "folder": "s3_02_dropout_regularisation", "has_app": True, "minutes": 90,
             "icon": "lesson-dropout"},
            {"id": "s3_03", "num": 3, "title": "Convolutional Neural Networks",
             "desc": "Image recognition with CNNs",
             "folder": "s3_03_convolutional_networks", "has_app": True, "minutes": 120,
             "icon": "lesson-cnn"},
            {"id": "s3_04", "num": 4, "title": "Hyperparameters & Tuning",
             "desc": "Systematic model optimization",
             "folder": "s3_04_hyperparameter_tuning", "has_app": True, "minutes": 90,
             "icon": "lesson-tuning"},
        ],
    },
    {
        ...
        "lessons": [
            {"id": "s4_01", "num": 1, "title": "How LLMs Work",
             ...
             "icon": "lesson-transformer"},
            {"id": "s4_02", "num": 2, "title": "HuggingFace Pre-trained Models",
             "desc": "Open-source model hub and inference",
             "folder": "s4_02_huggingface", "has_app": True, "minutes": 90,
             "icon": "lesson-hf"},
            {"id": "s4_03", "num": 3, "title": "Working with LLM APIs",
             "desc": "Building applications with LLM APIs",
             "folder": "s4_03_llm_api", "has_app": True, "minutes": 90,
             "icon": "lesson-api"},
            {"id": "s4_04", "num": 4, "title": "Retrieval-Augmented Generation",
             "desc": "Retrieve, augment, generate — ground LLMs in your docs",
             "folder": "s4_04_rag", "has_app": True, "minutes": 120,
             "icon": "lesson-rag"},
        ],
    },
    {
        ...
        "lessons": [
            {"id": "s5_01", "num": 1, "title": "Workforce AI Security",
             ...
             "icon": "lesson-workforce"},
            {"id": "s5_02", "num": 2, "title": "AI Agent Security + MCP",
             "desc": "Protecting autonomous AI agents",
             "folder": "s5_02_ai_agent_security", "has_app": True, "minutes": 60,
             "icon": "lesson-agent"},
            {"id": "s5_03", "num": 3, "title": "AI Guardrails",
             "desc": "Content safety and policy enforcement",
             "folder": "s5_03_ai_guardrails", "has_app": True, "minutes": 60,
             "icon": "lesson-guardrails"},
            {"id": "s5_04", "num": 4, "title": "Positioning Check Point AI Security",
             "desc": "Technical depth for customer engagements",
             "folder": "s5_04_positioning_cp_ai", "has_app": True, "minutes": 60,
             "icon": "lesson-positioning"},
        ],
    },
]
